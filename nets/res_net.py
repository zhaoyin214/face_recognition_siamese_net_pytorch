...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_channels, channels, stride=1, down_sample=None, groups=1,
        ...
        # Both self.conv1 and self.down_sample layers downsample the input when stride != 1
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, in_channels, channels, stride=1, down_sample=None, groups=1,
        ...
        # Both self.conv2 and self.down_sample layers downsample the input when stride != 1
...
class ResNet(nn.Module):
    ...
    def _make_layer(self, block, channels, num_blocks, stride=1, dilate=False):
        ...
        layers = []
        layers.append(block(self.in_channels, channels, stride, down_sample, self.groups,
